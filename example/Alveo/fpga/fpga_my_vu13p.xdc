...
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[0]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[0]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[0]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[0]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[1]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[1]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[1]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[1]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[2]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[3]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[2]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[3]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[2]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[3]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[2]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[3]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[4]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[5]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[6]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[7]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[4]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[5]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[6]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[7]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[4]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[5]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[6]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[7]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[4]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[5]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[6]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[7]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[8]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[9]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[10] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[11] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[12] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[13] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[14] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_p[15] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[8]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[9]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[10] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[11] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[12] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[13] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[14] ]
#set_property PACKAGE_PIN "" [get_ports pcie_tx_n[15] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[8]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[9]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[10] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[11] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[12] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[13] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[14] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_p[15] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[8]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[9]  ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[10] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[11] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[12] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[13] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[14] ]
#set_property PACKAGE_PIN "" [get_ports pcie_rx_n[15] ]
#
## PCIe Interface
set_property -dict {LOC BF5 } [get_ports pcie_tx_p[0]  ]
set_property -dict {LOC BF4 } [get_ports pcie_tx_n[0]  ]
set_property -dict {LOC BC2 } [get_ports pcie_rx_p[0]  ]
set_property -dict {LOC BC1 } [get_ports pcie_rx_n[0]  ]
set_property -dict {LOC BD5 } [get_ports pcie_tx_p[1]  ]
set_property -dict {LOC BD4 } [get_ports pcie_tx_n[1]  ]
set_property -dict {LOC BA2 } [get_ports pcie_rx_p[1]  ]
set_property -dict {LOC BA1 } [get_ports pcie_rx_n[1]  ]
set_property -dict {LOC BB5 } [get_ports pcie_tx_p[2]  ]
set_property -dict {LOC AV7 } [get_ports pcie_tx_p[3]  ]
set_property -dict {LOC BB4 } [get_ports pcie_tx_n[2]  ]
set_property -dict {LOC AV6 } [get_ports pcie_tx_n[3]  ]
set_property -dict {LOC AW4 } [get_ports pcie_rx_p[2]  ]
set_property -dict {LOC AV2 } [get_ports pcie_rx_p[3]  ]
set_property -dict {LOC AW3 } [get_ports pcie_rx_n[2]  ]
set_property -dict {LOC AV1 } [get_ports pcie_rx_n[3]  ]
set_property -dict {LOC AU9 } [get_ports pcie_tx_p[4]  ]
set_property -dict {LOC AT7 } [get_ports pcie_tx_p[5]  ]
set_property -dict {LOC AR9 } [get_ports pcie_tx_p[6]  ]
set_property -dict {LOC AP7 } [get_ports pcie_tx_p[7]  ]
set_property -dict {LOC AU8 } [get_ports pcie_tx_n[4]  ]
set_property -dict {LOC AT6 } [get_ports pcie_tx_n[5]  ]
set_property -dict {LOC AR8 } [get_ports pcie_tx_n[6]  ]
set_property -dict {LOC AP6 } [get_ports pcie_tx_n[7]  ]
set_property -dict {LOC AU4 } [get_ports pcie_rx_p[4]  ]
set_property -dict {LOC AT2 } [get_ports pcie_rx_p[5]  ]
set_property -dict {LOC AR4 } [get_ports pcie_rx_p[6]  ]
set_property -dict {LOC AP2 } [get_ports pcie_rx_p[7]  ]
set_property -dict {LOC AU3 } [get_ports pcie_rx_n[4]  ]
set_property -dict {LOC AT1 } [get_ports pcie_rx_n[5]  ]
set_property -dict {LOC AR3 } [get_ports pcie_rx_n[6]  ]
set_property -dict {LOC AP1 } [get_ports pcie_rx_n[7]  ]
set_property -dict {LOC AN9 } [get_ports pcie_tx_p[8]  ]
set_property -dict {LOC AM7 } [get_ports pcie_tx_p[9]  ]
set_property -dict {LOC AL9 } [get_ports pcie_tx_p[10] ]
set_property -dict {LOC AK7 } [get_ports pcie_tx_p[11] ]
set_property -dict {LOC AJ9 } [get_ports pcie_tx_p[12] ]
set_property -dict {LOC AH7 } [get_ports pcie_tx_p[13] ]
set_property -dict {LOC AG9 } [get_ports pcie_tx_p[14] ]
set_property -dict {LOC AF7 } [get_ports pcie_tx_p[15] ]
set_property -dict {LOC AN8 } [get_ports pcie_tx_n[8]  ]
set_property -dict {LOC AM6 } [get_ports pcie_tx_n[9]  ]
set_property -dict {LOC AL8 } [get_ports pcie_tx_n[10] ]
set_property -dict {LOC AK6 } [get_ports pcie_tx_n[11] ]
set_property -dict {LOC AJ8 } [get_ports pcie_tx_n[12] ]
set_property -dict {LOC AH6 } [get_ports pcie_tx_n[13] ]
set_property -dict {LOC AG8 } [get_ports pcie_tx_n[14] ]
set_property -dict {LOC AF6 } [get_ports pcie_tx_n[15] ]
set_property -dict {LOC AN4 } [get_ports pcie_rx_p[8]  ]
set_property -dict {LOC AM2 } [get_ports pcie_rx_p[9]  ]
set_property -dict {LOC AL4 } [get_ports pcie_rx_p[10] ]
set_property -dict {LOC AK2 } [get_ports pcie_rx_p[11] ]
set_property -dict {LOC AJ4 } [get_ports pcie_rx_p[12] ]
set_property -dict {LOC AH2 } [get_ports pcie_rx_p[13] ]
set_property -dict {LOC AG4 } [get_ports pcie_rx_p[14] ]
set_property -dict {LOC AF2 } [get_ports pcie_rx_p[15] ]
set_property -dict {LOC AN3 } [get_ports pcie_rx_n[8]  ]
set_property -dict {LOC AM1 } [get_ports pcie_rx_n[9]  ]
set_property -dict {LOC AL3 } [get_ports pcie_rx_n[10] ]
set_property -dict {LOC AK1 } [get_ports pcie_rx_n[11] ]
set_property -dict {LOC AJ3 } [get_ports pcie_rx_n[12] ]
set_property -dict {LOC AH1 } [get_ports pcie_rx_n[13] ]
set_property -dict {LOC AG3 } [get_ports pcie_rx_n[14] ]
set_property -dict {LOC AF1 } [get_ports pcie_rx_n[15] ]

set_property -dict {LOC AK11 } [get_ports pcie_refclk_p]
set_property -dict {LOC AK10 } [get_ports pcie_refclk_n]
